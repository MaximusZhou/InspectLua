/*
	Luanr is used to provide access to C++ classes from within Lua.
	Lunar(http://lua-users.org/wiki/CppBindingWithLunar) is an improved
	version of Luna(http://lua-users.org/wiki/LunaFive)
*/
